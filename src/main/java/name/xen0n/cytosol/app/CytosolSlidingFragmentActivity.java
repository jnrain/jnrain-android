...
import name.xen0n.cytosol.app.base.SpicedRoboSlidingFragmentActivity;
...
public abstract class CytosolSlidingFragmentActivity<T>
        extends SpicedRoboSlidingFragmentActivity<T> {
    private CytosolActivityHelper _helper;

    protected CytosolSlidingFragmentActivity(
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _helper.setUpSlidingMenu(getSlidingMenu());
    }
}
