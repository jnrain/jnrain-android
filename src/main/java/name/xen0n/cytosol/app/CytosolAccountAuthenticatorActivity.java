...
import name.xen0n.cytosol.app.base.SpicedRoboAccountAuthenticatorActivity;
...
public abstract class CytosolAccountAuthenticatorActivity<T>
        extends SpicedRoboAccountAuthenticatorActivity<T> {
    private CytosolActivityHelper _helper;

    protected CytosolAccountAuthenticatorActivity(
