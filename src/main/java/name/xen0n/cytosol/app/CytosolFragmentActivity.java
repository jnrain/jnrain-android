...
import name.xen0n.cytosol.app.base.SpicedRoboFragmentActivity;
...
public abstract class CytosolFragmentActivity<T>
        extends SpicedRoboFragmentActivity<T> {
    private CytosolActivityHelper _helper;

    protected CytosolFragmentActivity(
