...
public class StaticCacheHelper {
     ...
     * object's expiration date to the current time and only returns the
     * object if the expiration date has not passed.
     * 
     * @param cacheKey
     * @return
     */
    ...
    /**
     * Stores an object in the cache, wrapped by an Element object. The
     * Element object has an expiration date, which will be set to now + this
     * class' TIME_TO_LIVE setting.
     * 
     * @param cacheKey
     * @param object
     */
    ...
    /**
     * Stores an object in the cache, wrapped by an Element object. The
     * Element object has an expiration date, which will be set to now + the
     ...
     */
    public static void storeObjectInCache(
            String cacheKey,
            Object object,
