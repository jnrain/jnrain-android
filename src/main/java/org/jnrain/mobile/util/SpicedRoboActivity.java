...
public class SpicedRoboActivity<T> extends RoboSherlockActivity implements
		SpiceRequestListener<T> {
	...
	public void makeSpiceRequest(SpiceRequest<T> request,
		...
		spiceManager.execute(request, requestCacheKey, cacheDuration,
				requestListener);
	}
}
